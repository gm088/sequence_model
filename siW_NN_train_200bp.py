...
def model_builder(hp):
	...
	nb_f_l = hp.Int('filters', min_value=100, max_value=190, step=20)
	#nb_f_l=[90,100]
	f_len_l=hp.Int('kernel_size', min_value=8, max_value=100, step=4)
	#f_len_l=[7,7]
...
fg_fasta_data = IOHelper.get_fastas_from_file("/hpcnfs/data/GN2/gmandana/bin/4.1.0/home/ieo5559/unifiedCLIP/NN_files/siW/fg_200bp.fa", uppercase=True)
bg_fasta_data = IOHelper.get_fastas_from_file("/hpcnfs/data/GN2/gmandana/bin/4.1.0/home/ieo5559/unifiedCLIP/NN_files/siW/bg_200bp.fa", uppercase=True)
...
tuner = kt.Hyperband(model_builder,
                     ...
                     max_epochs=10,
                     factor=3,
                     directory='/hpcnfs/data/GN2/gmandana/bin/restr_NN/200bp/',
					 overwrite = True)
...
checkpointer = ModelCheckpoint(filepath = os.path.join(model_path, "siW_NN_200bp.keras"), verbose=1, save_best_only=True)
...
model.save(os.path.join(model_path, "siW_NN_200bp" + ".keras"))
